...
public final class NetworkMonitor_Factory implements Factory<NetworkMonitor> {
  ...
  public static NetworkMonitor_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new NetworkMonitor_Factory(Providers.asDaggerProvider(contextProvider));
  }
