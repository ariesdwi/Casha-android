...
public final class SubscriptionManager_Factory implements Factory<SubscriptionManager> {
  ...
  public static SubscriptionManager_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new SubscriptionManager_Factory(Providers.asDaggerProvider(contextProvider));
  }
