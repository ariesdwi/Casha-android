...
public final class DaggerCashaApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends CashaApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.goalTrackerViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 4);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.casha.app.ui.feature.budget.BudgetViewModel 
          ...
          case 4: // com.casha.app.ui.feature.goaltracker.GoalTrackerViewModel 
          return (T) new GoalTrackerViewModel(viewModelCImpl.getGoalsUseCase(), viewModelCImpl.getGoalSummaryUseCase());

          case 5: // com.casha.app.ui.feature.auth.LoginViewModel 
          ...
          case 6: // com.casha.app.ui.feature.profile.ProfileViewModel 
  ...
  private static final class SingletonCImpl extends CashaApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideBudgetApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<BudgetApiService>(singletonCImpl, 12));
      this.budgetRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<BudgetRepositoryImpl>(singletonCImpl, 11));
      this.provideCategoryApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<CategoryApiService>(singletonCImpl, 14));
      this.categoryRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<CategoryRepositoryImpl>(singletonCImpl, 13));
      this.networkMonitorProvider = DoubleCheck.provider(new SwitchingProvider<NetworkMonitor>(singletonCImpl, 15));
      this.provideTransactionApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<TransactionApiService>(singletonCImpl, 17));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 18: // com.casha.app.data.remote.impl.GoalRepositoryImpl 
